create database if not exists finacial_management default charset utf8 collate utf8_general_ci;
...
create table users(
    ...
    created_at double not null COMMENT '创建时间',
    primary key (id)
...
create table records(
    ...
    type tinyint(1) not null COMMENT '类型:0支出, 1收入',
...
create table types(
    ...
    orders int not null COMMENT '顺序',
    created_at double not null COMMENT '创建时间',
    primary key (id)
